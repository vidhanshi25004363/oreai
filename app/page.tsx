...
import { Activity, AlertTriangle, Battery, Bell, Bot, ChevronRight, CircleDot, Cpu, Gauge, HardHat, Layers3, MapPin, Moon, Radio, RefreshCcw, Settings, ShieldCheck, Signal, Sun, TrendingUp, Wifi, X } from 'lucide-react'
...
export default function Page() {
  ...
  useEffect(() => {
    const savedTheme = window.localStorage.getItem('ore-ai-theme')
    if (savedTheme === 'light' || savedTheme === 'dark') setTheme(savedTheme)
  }, [])

  useEffect(() => {
    document.documentElement.dataset.theme = theme
    window.localStorage.setItem('ore-ai-theme', theme)
  }, [theme])
